...
pub const DATABASE_URL_ENV: &str = "ROBOT_KANBAN_SERVICE_CORE_DATABASE_URL";
...
pub fn module() -> teaql_runtime::RuntimeModule {
    teaql_runtime::RuntimeModule::new()
        ...
        .initial_graph(teaql_runtime::GraphNode::new("Platform")
            .value("id", 1_u64)
            .value("name", "Pending")
            .value("founded", teaql_core::time::Timestamp::now())
            .value("user_email", "Pending")
            .value("version", 1_i64))
        .initial_graph(teaql_runtime::GraphNode::new("TaskStatus")
            ...
            .value("code", "PLANNED")
            .value("color", "#94A3B8")
            .value("display_order", 10_i32)
            .value("progress", 0_i32)
            .value("version", 1_i64)
        ...
        .initial_graph(teaql_runtime::GraphNode::new("TaskStatus")
            ...
            .value("code", "READY")
            .value("color", "#3B82F6")
            .value("display_order", 20_i32)
            .value("progress", 25_i32)
            .value("version", 1_i64)
            .value("platform_id", 1_u64))
        .initial_graph(teaql_runtime::GraphNode::new("TaskStatus")
            .value("id", 1003_u64)
            ...
            .value("color", "#F59E0B")
            .value("display_order", 30_i32)
            .value("progress", 50_i32)
            .value("version", 1_i64)
            .value("platform_id", 1_u64))
        .initial_graph(teaql_runtime::GraphNode::new("TaskStatus")
            .value("id", 1004_u64)
            ...
            .value("code", "VERIFIED")
            .value("color", "#16A34A")
            .value("display_order", 40_i32)
            .value("progress", 100_i32)
            .value("version", 1_i64)
            .value("platform_id", 1_u64))
}
