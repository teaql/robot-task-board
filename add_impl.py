...
content = content.replace("impl UserContextExt for UserContext {", impl_code + "\nimpl UserContextExt for UserContext {")
content = content.replace("let service_runtime_executor = robot_kanban::ServiceRuntimeExecutor::new(inner_executor.clone());", "")
