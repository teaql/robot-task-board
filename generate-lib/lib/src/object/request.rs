...
impl EntityReference for crate::Object {
...
#[derive(Debug)]
pub struct ObjectRequest<R = crate::Object> {
    query: SelectQuery,
...
impl<R> Clone for ObjectRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> ObjectRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("Object"),
    ...
    pub fn return_type<T>(self) -> ObjectRequest<T> {
        ObjectRequest {
            query: self.query,
    ...
    pub fn new_entity<C>(&self, ctx: &C) -> crate::Object
    where
        C: TeaqlRuntime + ?Sized,
    {
        crate::Object::runtime_new(ctx.user_context().entity_root())
    }
        ...
        C: TeaqlRepositoryProvider + ?Sized,
    {
        ...
        rows.first()
            ...
            .ok_or_else(|| RepositoryError::Runtime(RuntimeError::Graph(format!("count result for Object is missing or not numeric"))))
    }
    ...
    pub fn name_is_task(self) -> Self {
        self.with_name_is("task")
    }

    pub fn with_name_is_task(self) -> Self {
        self.with_name_is("task")
    }



    pub fn with_name_is_not_task(self) -> Self {
        self.with_name_is_not("task")
    }
...
impl<R> Default for ObjectRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< ObjectRequest<R> > for SelectQuery {
    fn from(request: ObjectRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< ObjectRequest<R> > for QuerySelection {
    fn from(request: ObjectRequest<R>) -> Self {
        Self {
            query: request.query,
