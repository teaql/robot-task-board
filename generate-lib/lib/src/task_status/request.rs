...
impl<R: teaql_core::Entity> crate::q::PurposedQuery<TaskStatusRequest<R>> {
    pub async fn execute_for_list<C>(self, ctx: &C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
    ...
    pub async fn execute_for_first<C>(self, ctx: &C) -> Result<Option<R>, crate::request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<C>(self, ctx: &C) -> Result<Option<R>, crate::request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_by_id<C>(self, ctx: &C, id: impl Into<teaql_core::Value>) -> Result<Option<R>, crate::request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<C>(self, ctx: &C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<C>(self, ctx: &C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<C>(self, ctx: &C) -> Result<u64, crate::request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
