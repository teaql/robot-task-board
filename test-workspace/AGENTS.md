...
This workspace is the editable Rust application layer for the generated TeaQL domain crate `robot-kanban-service`.
...
├── lib/
│   └── robot_kanban_service/    # Generated domain crate (Do not edit generated files)
├── models/
│   └── robot-kanban-service.xml           # Source of truth (KSML model)
└── src/
...
```toml
robot_kanban_service = { package = "robot-kanban-service", path = "../generate-lib/lib" }
```
...
Import generated APIs from `robot_kanban_service`:
...
Create new generated entities with `Q::platforms().purpose("purpose").new_entity(&ctx)` or the corresponding `Q::<entity_plural>().purpose("purpose").new_entity(&ctx)` entrypoint; do not call `runtime_new(...)`, `entity_root()`, repositories, or runtime internals to construct entities.
