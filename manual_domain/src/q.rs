...
pub trait TeaqlRepositoryProvider: TeaqlRuntime {
    ...
    type PlatformRepository<'a> = teaql_runtime::ResolvedRepository<'a, crate::ServiceRuntimeExecutor> where Self: 'a;

    fn platform_repository(&self) -> Result<Self::PlatformRepository<'_>, teaql_runtime::ContextError> {
        self.resolve_repository::<crate::ServiceRuntimeExecutor>("platform")
    }
    type TaskStatusRepository<'a> = teaql_runtime::ResolvedRepository<'a, crate::ServiceRuntimeExecutor> where Self: 'a;

    fn task_status_repository(&self) -> Result<Self::TaskStatusRepository<'_>, teaql_runtime::ContextError> {
        self.resolve_repository::<crate::ServiceRuntimeExecutor>("task_status")
    }
    type TaskRepository<'a> = teaql_runtime::ResolvedRepository<'a, crate::ServiceRuntimeExecutor> where Self: 'a;

    fn task_repository(&self) -> Result<Self::TaskRepository<'_>, teaql_runtime::ContextError> {
        self.resolve_repository::<crate::ServiceRuntimeExecutor>("task")
    }
    type TaskExecutionLogRepository<'a> = teaql_runtime::ResolvedRepository<'a, crate::ServiceRuntimeExecutor> where Self: 'a;

    fn task_execution_log_repository(&self) -> Result<Self::TaskExecutionLogRepository<'_>, teaql_runtime::ContextError> {
        self.resolve_repository::<crate::ServiceRuntimeExecutor>("task_execution_log")
    }
}
...
impl<R> PlatformRequest<R> {
    ...
    pub fn with_name_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("name", value.into()));
        self
    }
    ...
    pub fn with_name_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("name", value.into()));
        self
    }

    pub fn with_name_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("name", value.into()));
        self
    }
...
impl<R> TaskStatusRequest<R> {
    ...
    pub fn with_code_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("code", value.into()));
        self
    }
    ...
    pub fn with_code_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("code", value.into()));
        self
    }

    pub fn with_code_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("code", value.into()));
        self
    }
    ...
    pub fn with_color_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("color", value.into()));
        self
    }
    ...
    pub fn with_color_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("color", value.into()));
        self
    }

    pub fn with_color_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("color", value.into()));
        self
    }
...
impl<R> TaskExecutionLogRequest<R> {
    ...
    pub fn with_action_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("action", value.into()));
        self
    }
    ...
    pub fn with_action_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("action", value.into()));
        self
    }

    pub fn with_action_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("action", value.into()));
        self
    }
    ...
    pub fn with_detail_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("detail", value.into()));
        self
    }
    ...
    pub fn with_detail_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("detail", value.into()));
        self
    }

    pub fn with_detail_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("detail", value.into()));
        self
    }
...
impl<R: teaql_core::Entity> crate::q::PurposedQuery<PlatformRequest<R>> {
    pub async fn execute_for_list<C>(self, ctx: &C) -> Result<teaql_core::SmartList<R>, request_support::TeaqlRepositoryError<C::PlatformRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<C>(self, ctx: &C) -> Result<Option<R>, request_support::TeaqlRepositoryError<C::PlatformRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<C>(self, ctx: &C) -> Result<Option<R>, request_support::TeaqlRepositoryError<C::PlatformRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_by_id<C>(self, ctx: &C, id: impl Into<teaql_core::Value>) -> Result<Option<R>, request_support::TeaqlRepositoryError<C::PlatformRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<C>(self, ctx: &C) -> Result<teaql_core::SmartList<teaql_core::Record>, request_support::TeaqlRepositoryError<C::PlatformRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<C>(self, ctx: &C) -> Result<Option<teaql_core::Record>, request_support::TeaqlRepositoryError<C::PlatformRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<C>(self, ctx: &C) -> Result<u64, request_support::TeaqlRepositoryError<C::PlatformRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
...
impl<R: teaql_core::Entity> teaql_core::PurposedQuery<PlatformRequest<R>> {
    pub fn new_entity(&self, _ctx: &teaql_runtime::UserContext) -> crate::Platform {
        crate::Platform::new()
    }
}
impl<R: teaql_core::Entity> crate::q::PurposedQuery<TaskStatusRequest<R>> {
    pub async fn execute_for_list<C>(self, ctx: &C) -> Result<teaql_core::SmartList<R>, request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_list(ctx).await
    ...
    pub async fn execute_for_first<C>(self, ctx: &C) -> Result<Option<R>, request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_first(ctx).await
    ...
    pub async fn execute_for_one<C>(self, ctx: &C) -> Result<Option<R>, request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_one(ctx).await
    ...
    pub async fn execute_by_id<C>(self, ctx: &C, id: impl Into<teaql_core::Value>) -> Result<Option<R>, request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_by_id(ctx, id).await
    ...
    pub async fn execute_for_records<C>(self, ctx: &C) -> Result<teaql_core::SmartList<teaql_core::Record>, request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_records(ctx).await
    ...
    pub async fn execute_for_record<C>(self, ctx: &C) -> Result<Option<teaql_core::Record>, request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_record(ctx).await
    ...
    pub async fn execute_for_count<C>(self, ctx: &C) -> Result<u64, request_support::TeaqlRepositoryError<C::TaskStatusRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_count(ctx).await
...
impl<R: teaql_core::Entity> teaql_core::PurposedQuery<TaskStatusRequest<R>> {
    pub fn new_entity(&self, _ctx: &teaql_runtime::UserContext) -> crate::TaskStatus {
        crate::TaskStatus::new()
    }
}
impl<R: teaql_core::Entity> crate::q::PurposedQuery<TaskRequest<R>> {
    pub async fn execute_for_list<C>(self, ctx: &C) -> Result<teaql_core::SmartList<R>, request_support::TeaqlRepositoryError<C::TaskRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_list(ctx).await
    ...
    pub async fn execute_for_first<C>(self, ctx: &C) -> Result<Option<R>, request_support::TeaqlRepositoryError<C::TaskRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_first(ctx).await
    ...
    pub async fn execute_for_one<C>(self, ctx: &C) -> Result<Option<R>, request_support::TeaqlRepositoryError<C::TaskRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_one(ctx).await
    ...
    pub async fn execute_by_id<C>(self, ctx: &C, id: impl Into<teaql_core::Value>) -> Result<Option<R>, request_support::TeaqlRepositoryError<C::TaskRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_by_id(ctx, id).await
    ...
    pub async fn execute_for_records<C>(self, ctx: &C) -> Result<teaql_core::SmartList<teaql_core::Record>, request_support::TeaqlRepositoryError<C::TaskRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_records(ctx).await
    ...
    pub async fn execute_for_record<C>(self, ctx: &C) -> Result<Option<teaql_core::Record>, request_support::TeaqlRepositoryError<C::TaskRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_record(ctx).await
    ...
    pub async fn execute_for_count<C>(self, ctx: &C) -> Result<u64, request_support::TeaqlRepositoryError<C::TaskRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_count(ctx).await
...
impl<R: teaql_core::Entity> teaql_core::PurposedQuery<TaskRequest<R>> {
...
impl<R: teaql_core::Entity> crate::q::PurposedQuery<TaskExecutionLogRequest<R>> {
    pub async fn execute_for_list<C>(self, ctx: &C) -> Result<teaql_core::SmartList<R>, request_support::TeaqlRepositoryError<C::TaskExecutionLogRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_list(ctx).await
    ...
    pub async fn execute_for_first<C>(self, ctx: &C) -> Result<Option<R>, request_support::TeaqlRepositoryError<C::TaskExecutionLogRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_first(ctx).await
    ...
    pub async fn execute_for_one<C>(self, ctx: &C) -> Result<Option<R>, request_support::TeaqlRepositoryError<C::TaskExecutionLogRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_one(ctx).await
    ...
    pub async fn execute_by_id<C>(self, ctx: &C, id: impl Into<teaql_core::Value>) -> Result<Option<R>, request_support::TeaqlRepositoryError<C::TaskExecutionLogRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_by_id(ctx, id).await
    ...
    pub async fn execute_for_records<C>(self, ctx: &C) -> Result<teaql_core::SmartList<teaql_core::Record>, request_support::TeaqlRepositoryError<C::TaskExecutionLogRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_records(ctx).await
    ...
    pub async fn execute_for_record<C>(self, ctx: &C) -> Result<Option<teaql_core::Record>, request_support::TeaqlRepositoryError<C::TaskExecutionLogRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_record(ctx).await
    ...
    pub async fn execute_for_count<C>(self, ctx: &C) -> Result<u64, request_support::TeaqlRepositoryError<C::TaskExecutionLogRepository<'_>>>
    where
        C: request_support::TeaqlRepositoryProvider + ?Sized,
    {
        self.inner._execute_for_count(ctx).await
...
impl<R: teaql_core::Entity> teaql_core::PurposedQuery<TaskExecutionLogRequest<R>> {
